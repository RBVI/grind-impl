...
public class GrindNodeView extends AbstractGrindViewModel<CyNode> 
                           implements View<CyNode> {

	final GrindGraphView gView;
	
	public GrindNodeView(final GrindVisualLexicon grindLexicon, final GrindGraphView gView, 
	                     final CyNode node, final CyServiceRegistrar serviceRegistrar) {
		super(node, grindLexicon, serviceRegistrar);
		this.gView = gView;
	}
